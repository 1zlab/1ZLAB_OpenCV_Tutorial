...
简单来讲HaarCascade中的Haar指的是Haar-Like特征，Cascade代表级联，通过Adaboost算法将Haar-Like特征构成的弱分类器，级联为强分类器。 
...
在OpenCV的两个代码仓库里面都有预先训练好的HaarCascade模型。
